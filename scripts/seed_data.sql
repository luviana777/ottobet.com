-- Inserir dados iniciais no banco Otto Bet
...
INSERT IGNORE INTO admins (email, password_hash, role, permissions) VALUES 
('groupcephas@gmail.com', '$2b$10$N9qo8uLOickgx2ZMRZoMye.Uo04/OZLnQpjjf4Cu.dDt7/C5.JRrq', 'super_admin', 
'{"users": ["read", "write", "delete"], "games": ["read", "write", "delete"], "financial": ["read", "write"], "reports": ["read"], "system": ["read", "write"]}');

-- Inserir jogos populares
INSERT IGNORE INTO games (name, provider, category, rtp, status, min_bet, max_bet) VALUES
...
INSERT IGNORE INTO users (name, email, phone, password_hash, balance, status, kyc_verified, last_login) VALUES
...
INSERT IGNORE INTO transactions (user_id, type, amount, status, payment_method, description, created_at) VALUES
...
INSERT IGNORE INTO bets (user_id, game_id, bet_amount, win_amount, multiplier, status, created_at, completed_at) VALUES
...
INSERT IGNORE INTO suspicious_activity (user_id, activity_type, description, severity, ip_address, created_at) VALUES
(3, 'large_withdrawal', 'Tentativa de saque de R$ 500 - valor acima do padrão do usuário', 'medium', '192.168.1.100', '2024-01-15 16:00:00'),
(2, 'multiple_failed_logins', 'Múltiplas tentativas de login falharam', 'low', '192.168.1.200', '2024-01-14 08:30:00'),
(NULL, 'unusual_betting_pattern', 'Padrão de apostas incomum detectado', 'high', '192.168.1.300', '2024-01-15 17:00:00'),
(5, 'high_frequency_betting', 'Apostas em alta frequência detectadas', 'medium', '192.168.1.150', '2024-01-15 15:30:00'),
(NULL, 'potential_bot_activity', 'Atividade suspeita de bot detectada', 'high', '192.168.1.400', '2024-01-15 20:00:00');

-- Inserir promoções
INSERT IGNORE INTO promotions (name, description, type, bonus_amount, bonus_percentage, min_deposit, wagering_requirement, max_bonus, valid_from, valid_until, terms_conditions) VALUES
...
INSERT IGNORE INTO kyc_verifications (user_id, document_type, document_number, status, created_at) VALUES
...
INSERT IGNORE INTO user_bonuses (user_id, promotion_id, bonus_amount, wagering_requirement, wagered_amount, status, expires_at, created_at) VALUES
...
INSERT IGNORE INTO system_logs (level, message, context, user_id, admin_id, ip_address, created_at) VALUES
('info', 'Sistema iniciado com sucesso', '{"version": "1.0.0", "environment": "production"}', NULL, 1, '127.0.0.1', '2024-01-15 00:00:00'),
('info', 'Usuário realizou login', '{"login_method": "email"}', 1, NULL, '192.168.1.100', '2024-01-15 14:30:00'),
('warning', 'Tentativa de saque suspeita detectada', '{"amount": 500.00, "reason": "high_amount"}', 3, NULL, '192.168.1.100', '2024-01-15 16:00:00'),
('error', 'Falha na conexão com provedor de jogos', '{"provider": "Pragmatic Play", "error": "timeout"}', NULL, NULL, NULL, '2024-01-15 10:15:00'),
('info', 'Administrador acessou painel', '{"section": "user_management"}', NULL, 1, '192.168.1.50', '2024-01-15 09:00:00');
