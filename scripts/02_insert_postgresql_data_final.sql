...
TRUNCATE TABLE system_logs, user_bonuses, kyc_verifications, suspicious_activity, bets, transactions, games, users, admins, promotions, system_settings RESTART IDENTITY CASCADE;
...
-- Inserir jogos populares PRIMEIRO
...
-- Inserir usuários de exemplo SEGUNDO (senha: password123)
INSERT INTO users (name, email, phone, password_hash, balance, status, kyc_verified, last_login) VALUES
('João Silva', 'joao@email.com', '11999999999', '$2b$12$N9qo8uLOickgx2ZMRZoMye.Uo04/OZLnQpjjf4Cu.dDt7/C5.JRrq', 1250.50, 'active', TRUE, '2024-01-15 14:30:00'),
('Maria Santos', 'maria@email.com', '11888888888', '$2b$12$N9qo8uLOickgx2ZMRZoMye.Uo04/OZLnQpjjf4Cu.dDt7/C5.JRrq', 850.00, 'suspended', TRUE, '2024-01-14 09:15:00'),
('Pedro Costa', 'pedro@email.com', '11777777777', '$2b$12$N9qo8uLOickgx2ZMRZoMye.Uo04/OZLnQpjjf4Cu.dDt7/C5.JRrq', 2100.75, 'active', TRUE, '2024-01-15 16:45:00'),
('Ana Oliveira', 'ana@email.com', '11666666666', '$2b$12$N9qo8uLOickgx2ZMRZoMye.Uo04/OZLnQpjjf4Cu.dDt7/C5.JRrq', 450.25, 'pending_kyc', FALSE, '2024-01-13 11:20:00'),
('Carlos Ferreira', 'carlos@email.com', '11555555555', '$2b$12$N9qo8uLOickgx2ZMRZoMye.Uo04/OZLnQpjjf4Cu.dDt7/C5.JRrq', 3200.00, 'active', TRUE, '2024-01-15 18:20:00'),
('Lucia Mendes', 'lucia@email.com', '11444444444', '$2b$12$N9qo8uLOickgx2ZMRZoMye.Uo04/OZLnQpjjf4Cu.dDt7/C5.JRrq', 750.00, 'active', TRUE, '2024-01-15 12:00:00'),
('Roberto Lima', 'roberto@email.com', '11333333333', '$2b$12$N9qo8uLOickgx2ZMRZoMye.Uo04/OZLnQpjjf4Cu.dDt7/C5.JRrq', 1500.25, 'active', TRUE, '2024-01-15 19:30:00'),
('Fernanda Souza', 'fernanda@email.com', '11222222222', '$2b$12$N9qo8uLOickgx2ZMRZoMye.Uo04/OZLnQpjjf4Cu.dDt7/C5.JRrq', 320.00, 'pending_kyc', FALSE, '2024-01-14 16:15:00');

-- Inserir promoções TERCEIRO (antes dos bônus de usuários)
...
-- Inserir transações de exemplo (referenciando IDs corretos)
...
-- Inserir apostas de exemplo (referenciando IDs corretos)
...
-- Inserir atividades suspeitas (IPs corrigidos para formato INET válido)
...
(NULL, 'unusual_betting_pattern', 'Padrão de apostas incomum detectado', 'high', '10.0.0.50'::inet, '2024-01-15 17:00:00'),
(5, 'high_frequency_betting', 'Apostas em alta frequência detectadas', 'medium', '192.168.1.150'::inet, '2024-01-15 15:30:00'),
(NULL, 'potential_bot_activity', 'Atividade suspeita de bot detectada', 'high', '203.0.113.45'::inet, '2024-01-15 20:00:00');
...
-- Inserir bônus de usuários (referenciando IDs corretos)
...
-- Inserir logs do sistema (referenciando IDs corretos)
...
SELECT 
    'Admins: ' || COUNT(*) as resultado FROM admins
UNION ALL
SELECT 
    'Users: ' || COUNT(*) as resultado FROM users
UNION ALL
SELECT 
    'Games: ' || COUNT(*) as resultado FROM games
UNION ALL
SELECT 
    'Transactions: ' || COUNT(*) as resultado FROM transactions
UNION ALL
SELECT 
    'Bets: ' || COUNT(*) as resultado FROM bets
UNION ALL
SELECT 
    'Promotions: ' || COUNT(*) as resultado FROM promotions;
